    ...
    public void insertAfter(Node key, Node input) {
        ...
        do {
            if (temp.data == key.data && temp == tail) {
                this.addLast(input);
                found = true;
                System.out.println("Data " + input.data + " berhasil di tambahkan setelah data" + key.data);
                break;
            } else if (temp.data == key.data && temp != tail) {
                input.kanan = temp.kanan;
                temp.kanan.kiri = input;
                input.kiri = temp;
                temp.kanan = input;
        ...
        if (!found){
            System.out.println("Data" + key.data + "tidak ditemukan");
        }
    }
    ...
    public void insertBefore(Node key, Node input) {
        ...
        do {
            if (temp.data == key.data && temp == head) {
                this.addLast(input);
                found = true;
                System.out.println("Data " + input.data + " berhasil di tambahkan sebelum data" + key.data);
                break;
