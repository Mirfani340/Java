package com.test;
public class doubly implements list2{
    Node head, tail;
    ...
    public void insert(int index, Node input) {
        ...
        while (temp != null) {
            if (index == 0) {
                ...
                this.addLast(input);
                found = true;
                System.out.println("Data " + input.data + "berhasil dimasukkkan pada index " + " ke- " + index);
                break;
            }
            temp = temp.kanan;
            i++;
    ...
    public void removeAt(int index) {
        ...
        try {
            ...
            System.out.println("Index " + index + " out of bond!");
        }
    }
