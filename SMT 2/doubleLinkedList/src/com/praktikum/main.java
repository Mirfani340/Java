...
public class main {
    ...
    public static void main(String[] args) {
        ...
        try{
                    ...
                    case 14 :
                        ...
                        do {
                            ...
                            for (int i = 0; i < 1; i++) {
                                System.out.print("Insert Index Key :");
                                int key = scan.nextInt();
                                Node obj1 = new Node(key);
                                System.out.print("Insert Data :");
                                int input = scan.nextInt();
                                Node obj2 = new Node(input);
                                list.insertBefore(obj1, obj2);
                            }
                            list.show();
                            System.out.println("Repeat ?");
                            ask = scan.next();
            ...
            System.out.println("Soory Wrong Input, Input Number Only");
        }
